#ifndef __BLENDER_DISPATCHER_H__
#define __BLENDER_DISPATCHER_H__
...
namespace blender
{
	class Dispatcher : public optimization::Dispatcher
	{
		...
		private:
			...
			void OnBlenderKilled(GPid pid, int ret);
			...
			std::string ResolveBlenderExecutable(std::string const &path);
			bool Persistent();
...
#endif /* __BLENDER_DISPATCHER_H__ */
